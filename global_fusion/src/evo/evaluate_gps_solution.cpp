...
// std::string sol_folder = "/home/wws/fgo_gnss/FGO_trajectoryllh_psr_dop_fusion.csv"; // solution from FGO  gnss_ublox_wls.csv  FGO_trajectoryllh_psr_dop_fusion
// std::string gt_sol_folder = "/home/wws/fgo_gnss/src/fgo_gnss/global_fusion/src/rtk_estimator/gps_solution_TST/groundTruth_TST.csv";

// FILE* posError = fopen("/home/wws/fgo_gnss/src/fgo_gnss/global_fusion/src/rtk_estimator/gps_solution_TST/error.csv", "w+");
// FILE* trajectory = fopen("/home/wws/fgo_gnss/src/fgo_gnss/global_fusion/src/rtk_estimator/gps_solution_TST/trajectory.csv", "w+");


/* ublox midundao data 20200312 collected by guohao and Zhangbo*/
// std::string sol_folder = "/home/wws/fgo_gnss/FGO_trajectoryllh_psr_dop_fusion.csv"; // solution from FGO  gnss_ublox_wls.csv  FGO_trajectoryllh_psr_dop_fusion
// std::string gt_sol_folder = "/home/wws/fgo_gnss/src/fgo_gnss/global_fusion/src/rtk_estimator/Midundao_ublox_M8T/Route1/groundTruth_MDD.csv";
// FILE* posError = fopen("/home/wws/fgo_gnss/src/fgo_gnss/global_fusion/src/rtk_estimator/Midundao_ublox_M8T/Route1/error.csv", "w+");
// FILE* trajectory = fopen("/home/wws/fgo_gnss/src/fgo_gnss/global_fusion/src/rtk_estimator/Midundao_ublox_M8T/Route1/trajectory.csv", "w+");
