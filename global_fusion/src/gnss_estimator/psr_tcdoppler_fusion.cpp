...
#include "../../include/gnss_estimator/psr_tcdoppler_fusion.h"

class psr_tcdoppler_fusion
{
    ros::NodeHandle nh;
...
public:
    psr_tcdoppler_fusion()
    {
        ...
        optimizationThread = std::thread(&psr_tcdoppler_fusion::solveOptimization, this);
        ...
        syncdoppler2GNSSRaw->registerCallback(boost::bind(&psr_tcdoppler_fusion::gnssraw_doppler_msg_callback,this, _1, _2));
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "psr_tcdoppler_fusion_node"); 
    ROS_INFO("\033[1;32m----> psr_tcdoppler_fusion_node Started.\033[0m"); 
    // ...
    psr_tcdoppler_fusion psr_tcdoppler_fusion;
    ros::spin();
    return 0;
}
