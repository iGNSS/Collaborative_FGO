...
traj_data3 = csvread('trajectoryGNC.csv');
...
xlabel('east (meters)');
ylabel('north (meters)');
legend('\fontsize{16} GT','\fontsize{16} WLS','\fontsize{16} FGO-GNC','\fontsize{16} FGO');
...
error_data3 = csvread('errorGNC.csv');
...
xlabel('time (seconds)');
ylabel('error (meters)');
legend('\fontsize{16} WLS','\fontsize{16} FGO-GNC','\fontsize{16} FGO');
