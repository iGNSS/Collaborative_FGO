...
figure(1)
axis equal
plot(east_ref,north_ref,'k-','LineWidth',0.9 )
hold on;
plot(east_gnss,north_gnss,'r-','LineWidth',0.9 )
hold on;
grid on;
hold on;
axis equal
...
plot(error_epoch,error_gnss,'r-o','LineWidth',0.9 )
hold on;
plot(error_epoch,error_gnss_3d,'g-o','LineWidth',0.9 )
hold on;
grid on;
hold on;
ax = gca;
