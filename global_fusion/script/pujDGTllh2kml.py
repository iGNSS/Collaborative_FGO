...
class pullh2kml_eval():
    ...
    def standardGT2kml(self):
        ...
        self.Fcsv_GNSS = csv.reader(open('/home/wws/fgo_gnss/src/fgo_gnss/global_fusion/script/FGO_trajectoryllh.csv','r'))  # read csv context to csv_reader variable
...
if __name__ == '__main__':
	...
	if( len(pullh2kml_eval_.lon_)>5):
            ...
            with open('/home/wws/fgo_gnss/src/fgo_gnss/global_fusion/script/psr_doppler_final_traj.kml', 'w') as fp:
                fp.write(content)
